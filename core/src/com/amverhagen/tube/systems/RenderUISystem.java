...
public class RenderUISystem extends com.artemis.systems.EntityProcessingSystem {
	...
	@Wire
	ComponentMapper<RenderBody> dimensionMappper;
	@Wire
	...
	public RenderUISystem(SpriteBatch uiBatch, Camera uiCamera) {
		super(Aspect.all(Position.class, RenderBody.class, UIRenderable.class));
	...
	protected void process(Entity e) {
		...
		RenderBody dimensions = dimensionMappper.get(e);
